...
namespace UniFramework.Pooling
{
	public sealed class SpawnHandle : GameAsyncOperation
	{
		...
		internal SpawnHandle(GameObjectPool pool, InstantiateOperation operation, Transform parent, Vector3 position, Quaternion rotation, float scale = 1f, params System.Object[] userDatas)
		{
			_pool = pool;
		...
		protected override void OnUpdate()
		{
			...
			if (_steps == ESteps.Waiting)
			{
				...
				_operation.Result.transform.SetLocalPositionAndRotation(_position, _rotation);
				_operation.Result.transform.localScale = new Vector3(_scale, _scale, _scale);
