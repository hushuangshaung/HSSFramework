...
namespace UniFramework.Pooling
{
	internal class GameObjectPool
	{
		...
		/// 获取一个游戏对象
		/// </summary>
		public SpawnHandle Spawn(Transform parent, Vector3 position, Quaternion rotation, bool forceClone, float scale = 1f, params System.Object[] userDatas)
		{
			...
			SpawnCount++;
			SpawnHandle handle = new SpawnHandle(this, operation, parent, position, rotation, scale, userDatas);
